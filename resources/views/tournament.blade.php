...
@section('content')
  ...
  <div class="profile-page">
    <div class="page-header page-header-small">
      ...
      <div class="container">
        <img class="logo-torneo img-center" src="{{is_null($tournament->logo)?asset('frontend/assets/img/default.png'):Voyager::image($tournament->logo)}}" alt="tournament logo">
